...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.minophagen.co.jp/Japanese/info/index.html?page=1&year="
GAKKAI = "ミノファーゲン"

SELECTOR_TITLE = "div#XML div.news_area"
title_selector = "p:not(.date)"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div#XML div.news_area"
