...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.janssenpro.jp/Product-Notification"
GAKKAI = "ヤンセン"

SELECTOR_TITLE = "ul.search-result-list div.description"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.search-result-list div.date-time"  # typo修正済み
date_selector = ""
date_index = 0
year_unit = "/"
month_unit = "/"
