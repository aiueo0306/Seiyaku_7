...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.yutokuyakuhin.co.jp/info-bk.html"
GAKKAI = "祐徳薬品"

SELECTOR_TITLE = "table.table-info tr:nth-of-type(n+3)"
title_selector = "td"
title_index = 1
href_selector = "a"
href_index = 0
SELECTOR_DATE = "table.table-info tr:nth-of-type(n+3)"
date_selector = "th"
date_index = 0
year_unit = "年"
month_unit = "月"
