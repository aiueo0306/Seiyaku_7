...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://med.mochida.co.jp/products/"
GAKKAI = "持田製薬(医療従事者)"

SELECTOR_TITLE = "ul.c-news.f-allY.f-allL p.c-news__txt"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.c-news.f-allY.f-allL p.c-news__date"
date_selector = ""
date_index = 0
year_unit = "年"
month_unit = "月"
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed8-2.xml"
