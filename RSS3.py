...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.mikasaseiyaku.co.jp/latest"
GAKKAI = "三笠製薬"

SELECTOR_TITLE = "div#catlist a"
title_selector = ""
title_index = 2
href_selector = ""
href_index = 0
SELECTOR_DATE = "div#catlist dt"
date_selector = ""
date_index = 0
year_unit = "年"      # 年の後に区切り記号なし
month_unit = "月"    # 月と日の間の区切りスペース
day_unit = "日"      # 日の後にカンマ
