...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.yutokuyakuhin.co.jp/info/info01-bk2.html"
GAKKAI = "祐徳薬品(医療従事者)"

SELECTOR_TITLE = "ul.info-list li:not(.info-list__title)"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.info-list li:not(.info-list__title)"
date_selector = "div.info-list__date"
date_index = 0
year_unit = "."
month_unit = "."
day_unit = ""
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed10-2.xml"
