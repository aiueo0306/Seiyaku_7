...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://jp.mundipharma.com/press"
GAKKAI = "ムンディ"

SELECTOR_TITLE = "div.tab-panel:nth-of-type(1) tr"
title_selector = "td.views-field.views-field-title-1"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "div.tab-panel:nth-of-type(1) tr"
date_selector = "div.text.font-primary-medium"
date_index = 0
year_unit = ""
month_unit = " "
day_unit = " "
date_format = "%b %d, %Y"   # 短縮月名
date_regex = rf"(\d{{1,2}}){day_unit}([A-Za-z]{{3}}){month_unit}(\d{{2,4}}){year_unit}"
