...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.maruishi-pharm.co.jp/medical/newsrelease/"
GAKKAI = "丸石製薬（医療従事者）"

SELECTOR_TITLE = "ul.c-news-list li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.c-news-list li"
date_selector = "time"
date_index = 0
year_unit = "年"
month_unit = "月"
...
POPUP_BUTTONS = ["薬剤師"]  # 正確なボタン表記だけを指定
