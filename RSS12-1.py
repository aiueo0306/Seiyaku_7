...
# ===== 固定情報（学会サイト） =====
BASE_URL = "https://www.yoshindo.co.jp/info/"
GAKKAI = "陽進堂（インフォメーション）"

SELECTOR_TITLE = "ul.topic li"
title_selector = "a"
title_index = 0
href_selector = "a"
href_index = 0
SELECTOR_DATE = "ul.topic li"  # typo修正済み
date_selector = "time"
date_index = 0
year_unit = "."
month_unit = "."
...
POPUP_BUTTONS = ["すべての Cookie を受け入れる"] if POPUP_MODE else [] 
...
with sync_playwright() as p:
    ...
    rss_path = "rss_output/Feed12-1.xml"
